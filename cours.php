...
<html lang="fr">
  ...
  <body>
    ...
    <a href="docker.php" class="btn btn-primary">Accéder au cours</a>
        ...
        <div class="card" style="width: 18rem;">
                <img src="https://www.stor.fr/wp-content/uploads/2020/10/cyber-attack.jpg" class="card-img-top" alt="">
                <div class="card-body">
  ...
  <div class="card" style="width: 18rem;">
                <img src="https://i.ytimg.com/vi/0lsC4wtksgA/maxresdefault.jpg" class="card-img-top" alt="">
                <div class="card-body">
                <h5 class="card-title">Metasploitable 2</h5>
                 <p class="card-text">Téléchargement de metasploitable, connexion et identification</p>
            <a href="metasploitable.php" class="btn btn-primary">Accéder au cours</a>
          </div>
  </div>
</div>
<div class="card-group">
