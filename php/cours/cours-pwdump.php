            ...
            <div class="row"> 
               <!-- <div class="col-lg-9 blog-post-single"> -->
					...
					<!--	<div class="image-blog">-->
							<img src="../../images/pwdump0.png" alt="" class="img-fluid">
						</div>
	 ...
	 <div class="row align-items-center">
                <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12">
                    <div class="message-box">
                        ...
                        <p>PwDump est un nom regroupant tous les programmes permettant de récupérer les hash des mots de passe des utilisateurs sous Windows.					
</p>

                        <p>Les hash d'utilisateurs Windows sont stockés au format LM ou NTLM.
</p>

                        <p><b>INSTALLATION</b>
 </p>

                        <p>Lorsque vous téléchargez un programme PwDump, vous obtenez un fichier exécutable qu'il vous suffit de placer dans votre system32. 
						Vous pouvez dès lors utiliser les commandes pwdump dans votre invite de commandes.
</p>
<img src="../../images/pwdump2.png">
</br>
</br>
                        ...
                        <p> Tout d'abord il est très important de savoir que pwdump nécessite des <b>droits d'administrateur</b> pour être utilisé, si vous ne les avez pas déjà, 
						vous devrez dans un premier temps faire en sorte de les obtenir. Ensuite cela devient devient trivial, il vous suffit de taper <b>pwdump</b> dans 
						l'invite de commande afin d'obtenir les hash des mots de passe de tous les utilisateurs de la machine. La commande peut néamoins légèrement
						changer selon la version de pwdump, par exemple si vous utilisez PwDump v8.2, la commande à taper sera pwdump8.
</p>

						<p> pwdump -f suivi d'un nom de fichier vous permettra de récupérer les hash de mots de passe contenus dans un fichier SAM, pwdump -h vous affichera 
...
<p>Les premières versions de PwDump n'étaient que des améliorations fonctionnant toutes sous Windows NT et 2000, <b>PwDump5</b> introduit la compatibilité XP et Windows Server 2003,
<b>PwDump6</b> et <b>PwDump7</b> ajoutent la compatibilité avec Windows Vista et enfin <b>PwDump8</b> cumule Windows 2000, XP, Vista, 7, 8, 8.1, 10 ainsi que Windows Server 2008, 2012, 2016 et 2019.
</p>

<p>Il existe également des versions alternatives telles que <b>Quarks PwDump</b>. Cette version peut être vue comme le pont entre
PwDump7 et PwDump8 puisqu'elle est compatible avec Windows 7 et 8 mais pas avec Windows 10.
</p>


<p><b>POUR ALLER PLUS LOIN</b> 
<p>C'est bien beau d'avoir récupéré tous ces hash, mais seuls ils ne servent à rien. Pour savoir comment récupérer les mots de passe des utilisateurs
à partir des hash, je vous redirige vers le cours sur <a href="cours-john.php">John the Ripper</a>.
</p>
