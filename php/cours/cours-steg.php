            ...
            <div class="row"> 
               <!-- <div class="col-lg-9 blog-post-single"> -->
					...
					<!--	<div class="image-blog">-->
							<img src="../../images/stegano1.jpg" alt="" class="img-fluid">
						</div>
	 ...
	 <div class="row align-items-center">
                <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12">
                    <div class="message-box">
                        <h4></h4>
                        <h2><b>STEGANOGRAPHIE</b></h2>
                        <p>La stéganographie est apparue pendant l'antiquité où l’on avait par exemple des esclaves rasés où leurs crânes rasés étaient tatoués afin de cacher un message.
						
</p>

                        <p>La stéganographie est la dissimulation d'un message dans un autre message.
 </p>

                        <p>La stéganographie est différente de la cryptographie car cette dernière rend le message illisible à celui qui n'a pas sa clef.
 </p>

                        <p>La stéganographie a continué d'exister pendant l'histoire majoritairement utilisée en période de guerre.
</p>

                        <p>Il existe différentes méthodes de stéganographie :
</p>

                        <p>On peut dissimuler un document dans une image, en enlevant dans chaque pixel un bit de couleur et obtenir le stockage nécessaire pour y dissimuler un document.</p>

                        <p>Dans le domaine du réseaux on peut cacher des informations sur les différents protocoles comme l'IP ou le TCP.
