            ...
            <div class="row"> 
               <!-- <div class="col-lg-9 blog-post-single"> -->
					...
					<!--	<div class="image-blog">-->
							<img src="../../images/adware2.png" alt="" class="img-fluid">
						</div>
	 ...
	 <div class="row align-items-center">
                <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12">
                    <div class="message-box">
                        <h4></h4>
                        <h2><b>ADWARE</b></h2>
                        <p><b>Qu'est-ce que signifie adware?</b>
						
</p>

                        <p>Le terme « adware » désigne les programmes conçus pour afficher des publicités sur votre ordinateur, rediriger vos demandes de recherche vers des sites publicitaires et recueillir des données marketing vous concernant (par exemple, types de sites Internet que vous consultez) afin de vous adresser des publicités personnalisées.
                        ...
                        <p>Les adware qui recueillent des données avec votre autorisation ne doivent pas être confondus avec des chevaux de Troie espions qui recueillent des informations à votre insu. Si l’adware recueille des informations à votre insu, il est considéré comme malveillant (programme malveillant présentant le comportement d'un cheval de Troie espion, par exemple).

</p>

                       

                        <p><b>Impact des adware</b>
</p>

                        <p>Outre l'affichage de publicités et le recueil de données, les adware ne signalent généralement pas leur présence. Le plus souvent, le programme n'apparaît pas sur la barre d'état système et rien n'indique que des fichiers ont été installés sur votre ordinateur.



</p>

<p>Les adware peuvent s'installer sur votre ordinateur de deux façons :

</p>


<p><b>Via un freeware ou un shareware</b>
...
<p><b>Comment vous protéger contre les adware ?</b>
</p>
<p>Généralement, les adware ne sont dotés d'aucune fonctionnalité de désinstallation et ils peuvent employer des technologies semblables à celles utilisées par les virus pour s'introduire sur votre ordinateur et s'y exécuter à votre insu. Toutefois, dans la mesure où l’adware peut avoir été légalement installé sur votre ordinateur, les solutions antivirus ne permettent pas toujours de déterminer s'il représente une menace.
...
<p>https://www.kaspersky.fr/resource-center/threats/adware</p>
