          ...
          <div class="row">
            ...
            <div class="row"> 
                <div class="col-lg-4 col-md-6 col-12">
                    <div class="course-item">
						<div class="image-blog">
							<a href="cours/cours-docker.php"><img src="../images/docker.png" alt="" class="img-fluid">
						</div>
						<div class="course-br">
							<div class="course-title">
								<h2><a href="cours/cours-docker.php" title="">Docker</a></h2>
							</div>
                ...
                <div class="col-lg-4 col-md-6 col-12">
                    <div class="course-item">
						<div class="image-blog">
							<a href="cours/cours-meta.php"><img src="../images/metasploit.jpg" alt="" class="img-fluid">
						</div>
						<div class="course-br">
							<div class="course-title">
								<h2><a href="cours/cours-meta.php" title="">Metasploitable2</a></h2>
							</div>
							<div class="blog-desc">
				...
				<div class="col-lg-4 col-md-6 col-12">
                    <div class="course-item">
						<div class="image-blog">
							<a href="cours/cours-brute.php"><img src="../images/brute.png" alt="" class="img-fluid">
						</div>
						<div class="course-br">
							<div class="course-title">
								<h2><a href="cours/cours-brute.php">Bruteforce</a></h2>
							</div>
							<div class="course-desc">
            ...
            <div class="row"> 
				<div class="col-lg-4 col-md-6 col-12">
                   <div class="course-item">
						<div class="image-blog">
							<a href="cours/cours-steg.php"><img src="../images/stegano.png" alt="" class="img-fluid">
						</div>
						<div class="course-br">
							<div class="course-title">
								<h2><a href="cours/cours-steg.php" title="">Stéganographie</a></h2>
							</div>
							<div class="course-desc">
                 ...
                 <div class="col-lg-4 col-md-6 col-12">
                    <div class="course-item">
						<div class="image-blog">
							<a href="cours/cours-piratage.php"><img src="../images/pirate.jpg" alt="" class="img-fluid">
						</div>
						<div class="course-br">
							<div class="course-title">
								<h2><a href="cours/cours-piratage.php" title="">Le piratage informatique</a></h2>
							</div>
							<div class="blog-desc">
                ...
                <div class="col-lg-4 col-md-6 col-12">
                    <div class="course-item">
						<div class="image-blog">
							<a href="cours/cours-crypto.php"><img src="../images/crypto1.png" alt="" class="img-fluid">
						</div>
						<div class="course-br">
							<div class="course-title">
								<h2><a href="cours/cours-crypto.php" title="">La cryptologie</a></h2>
							</div>
							<div class="blog-desc">
            ...
            <div class="row"> 
				<div class="col-lg-4 col-md-6 col-12">
                   <div class="course-item">
						<div class="image-blog">
							<a href="cours/cours-sql.php"><img src="../images/sql1.jpg" alt="" class="img-fluid">
						</div>
						<div class="course-br">
							<div class="course-title">
								<h2><a href="cours/cours-sql.php" title="">Injection SQL</a></h2>
							</div>
							<div class="course-desc">
                 ...
                 <div class="col-lg-4 col-md-6 col-12">
                    <div class="course-item">
						<div class="image-blog">
							<a href="cours/cours-adware.php"><img src="../images/adware1.png" alt="" class="img-fluid">
						</div>
						<div class="course-br">
							<div class="course-title">
								<h2><a href="cours/cours-adware.php" title="">Adware</a></h2>
							</div>
							<div class="blog-desc">
				...
				<div class="col-lg-4 col-md-6 col-12">
                    <div class="course-item">
						<div class="image-blog">
							<a href="cours/cours-pwdump.php"><img src="../images/pwdump.png" alt="" class="img-fluid">
						</div>
						<div class="course-br">
							<div class="course-title">
								<h2><a href="cours/cours-pwdump.php" title="">PwDump</a></h2>
							</div>
							<div class="blog-desc">
								<p>Introduction à la récupération de hash de mots de passe utilisateurs Windows.
