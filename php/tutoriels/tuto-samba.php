                   ...
                   <!-- <div class="blog-item"> -->
						...
						<div class="post-content">
							...
							<div class="blog-desc">
								...
								Voici un tutoriel afin d'avoir accès au PC d'un autre en exploitant la faille Samba
								</blockquote>
								<div class="message-box">
								<p>Dans ce tutoriel, nous allons exploiter une faille sur le service Samba, pour cela nous allons utiliser metasploitable-framework.</p>

								<p>Dans un premier temps, nous allons chercher samba dans la console msfconsole</p>


								<p><img src="../../images/samba1.jpg" alt="" class="img-fluid"><br /></p>
								
							<p>	Ensuite, nous allons utiliser la commande use exploit/multi/samba/usermap_script :</p>
<br />

								<p><img src="../../images/samba2.jpg" alt="" class="img-fluid"><br /></p>

					<p>	Puis, nous allons utiliser la commande show options pour voir les options possibles pour cette faille :</p>



								<p><img src="../../images/samba3.jpg" alt="" class="img-fluid"><br /></p>

<p>Nous allons utiliser la commande set RHOSTS IP_de_la_victime :</p>


<p><img src="../../images/samba4.jpg" alt="" class="img-fluid"><br /></p>

<p>Pour finir, nous allons utiliser la commande exploit ou run pour exploiter la faille : <br /></p>

<p><img src="../../images/samba5.jpg" alt="" class="img-fluid"><br /></p>
...
<iframe width="560" height="315" src="https://www.youtube.com/embed/2ka8Coh9mgU" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
