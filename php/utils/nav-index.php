		...
		<nav class="navbar navbar-expand-lg navbar-light bg-light">
            ...
            ?>
						<li class="nav-item dropdown">
							<a class="nav-link" href="php/course-grid-3.php">Cours </a>
						...
						<li class="nav-item dropdown">
							<a class="nav-link" href="php/blog.php">Tutoriels </a>
						</li>
						<li class="nav-item"><a class="nav-link" href="php/pricing.php">Challenges</a></li>
						<li class="nav-item"><a class="nav-link" href="php/cyberprevention.php">Cyber Prevention</a></li>
						<li class="nav-item"><a class="nav-link" href="php/compte.php">Mon Compte</a></li>
						<li class="nav-item"><a class="nav-link" href="php/contact2.php">Contactez-nous</a></li>
					</ul>
					<ul class="nav navbar-nav navbar-right">
                        <li><a class="hover-btn-new log orange" href="php/deconnexion.php"><span>Deconnexion</span></a></li>
                    </ul>
                    <?php 
                    }
                    else
                    ...
                    ?> 
					<ul class="nav navbar-nav navbar-right">
                        <li><a class="hover-btn-new log orange" href="php/connexion.php" data-toggle="modal" data-target="#login"><span>Connexion</span></a></li>
                    </ul>
