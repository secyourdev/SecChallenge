<?php
$BDD=new PDO('mysql:host=localhost;dbname=dbsite;charset=utf8','cyber','cyber');
?>
<?php
	session_start();
?>
        ...
        <div class="container">
            <div class="section-title row text-center">
                <div class="col-md-8 offset-md-2">
                    <h3>Allez-vous réussir à trouver le contenu du fichier secret ?</h3>
                    <p class="lead"></p>
                </div>
            </div><!-- end title -->
                       ...
                       <p>Il est necessaire de récuperer <b>l'image Docker</b> dans lequel vous devrez trouver le fichier secret
                    </p>

                    <p><U>Pour cela :</U></p> 
                    	<p>- docker pull cybersecuriteach/challenge1:v0</p>
                    	<p>- docker run -it cybersecuriteach/challenge1:v0

                    <p>Puis on récupère l'image Docker representant la machine virtuelle <b>kali</b>. 
                    </p>

                    <p><U>Pour cela :</U></p> 
                    	<p>- docker pull cybersecuriteach/kali4fun:v0</p>
                    	<p>- docker run -it cybersecuriteach/kali4fun:v0
                    </p>

                     <h3><b>Objectifs</b></h3>

                      <p>Vous avez maintenant grâce aux 2 images recupérées une simulation d'attaques. La kali representera votre machine et l'image challenge1 representera la victime possédant le fichier secret.

                    </p>

                  <h3> <p> <b>L'objectif est donc de penetrer un serveur de la machine victime puis d'acceder au contenu du fichier secret.</b></p></h3>
...
<!--<div class="col-xl-6 col-lg-6 col-md-12 col-sm-12">
  ...
  if(isset($_POST['valider'])){
    ...
    if(!empty($_POST['answer'])){
      ...
      $q=$BDD->query('SELECT answer1 FROM reponse');
      $res=$q->fetch();
      if($res['answer1']==$answer){
      	  $nvscore='5';
      	  $mail=$_SESSION['mail'];
