        ...
        <div class="container">
            <div class="section-title row text-center">
                <div class="col-md-8 offset-md-2">
                    <h3>Pourras-tu decrypter le message ?</h3>
                    <p class="lead"></p>
                </div>
            </div><!-- end title -->
                        ...
                        <p>Installation d'un environnement Python</p>
                        <p>Dans ce challenge, nous mettons en lumiere une methode de chiffrement : le Code César. </p>
                        <p></p>


                        <p>Avec un algorithme de chiffrement, on obtient le code suivant :</p>
                       <p><b>ckxed dyed xo vywlo</b> 
                    </p>
                     ...
                     <h3><b>Objectifs</b></h3>
                      ...
                      <p>L'objectif de ce challenge est de mettre au point un algorithme de decryptage pour pouvoir retrouver le message originel.
                    </p>
...
<!--<div class="col-xl-6 col-lg-6 col-md-12 col-sm-12">
  ...
  if(isset($_POST['valider'])){
    ...
    if(!empty($_POST['answer'])){
      ...
      $q=$BDD->query('SELECT answer3 FROM reponse');
      $res=$q->fetch();
      if($res['answer3']==$answer){
      	  $nvscore='5';
      	  $mail=$_SESSION['mail'];
          $req=$BDD -> prepare('UPDATE utilisateur SET challenge3=:nvscore WHERE mail=:nmail');
