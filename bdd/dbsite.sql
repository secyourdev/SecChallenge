...
(9, 'pdf reverse shell', 'Comment prendre le contrôle d\'une machine Windows avec un fichier pdf ?', NULL, 'Tutoriel/tuto-reverse-shell/tuto_pdf_reverse_shell-gp3.html', 'Tutoriel/tuto-reverse-shell/cours-reverse-shell.png', 'Prise de contrôle'),
...
(29, 'Metasploit - Venom (MsfVenom : Payload generator & Encoder)', 'Tutoriel sur la génération et l\'encodage de payloads avec MsfVenom', NULL, 'Tutoriel/tuto-msfvenom/tuto-msfvenom.html', 'Tutoriel/tuto-msfvenom/metasploit.jpg', 'Prise de contrôle'),
(30, 'Metasploit - VNC BruteForcing', 'Tutoriel sur l\'attaque par bruteforce d\'une session VNC.', NULL, 'Tutoriel/tuto-vnc-bruteforcing/tuto-vnc-bruteforcing.html', 'Tutoriel/tuto-vnc-bruteforcing/metasploit.jpg', NULL),
...
(37, 'Geoint', 'Ce tutoriel vous apprendra les bases du geoint', 'quai_de_la_quarantaine', 'Tutoriel/tuto-geoint/tuto-geoint.html', 'Tutoriel/tuto-geoint/affiche.png', NULL),
